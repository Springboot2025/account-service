    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/**", "/api/address/**", "/api/search/**", "/api/devices/**", "/api/notifications/**", "/api/ratings/**", "/api/companies/**", "/api/webhooks/**", "/api/feedback/**", "/api/subscribers/**", "/api/contact/**", "/api/disputes/**").permitAll()
